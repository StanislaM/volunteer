...
const TelegramPopup = (props: Props) => {
    ...
    return (
        <>
            <div
                className="fixed right-4 top-48 z-[99999] flex h-[60px] max-w-[60px] cursor-pointer items-center justify-start overflow-hidden rounded-[10px] bg-[#CDEFFF] px-3 transition-all duration-300 hover:max-w-[350px]"
                role="button"
