...
const variants = {
    ...
    white: "h-[38px] w-full disabled:border-none enabled:border-2 rounded-[10px] outline-none bg-white py-2 px-4 text-xl font-medium placeholder:opacity-75 text-gray-dark",
};
